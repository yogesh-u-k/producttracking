    ...
    <div className="bg-white max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="items-start justify-between md:flex">
        <div className="max-w-lg">
          ...
          <p className="text-gray-600 mt-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta, sit! Error officiis officia fuga quaerat deleniti hic earum reprehenderit dolores obcaecati a, praesentium quia, ratione ex corrupti magnam quidem molestias.
          </p>
        </div>
      ...
      <div className="mt-12 shadow-sm border rounded-lg overflow-x-auto">
        <table className="w-full table-auto text-sm text-left">
          ...
          <tbody className="text-gray-600 divide-y table-auto">
            {allShipmentsdata?.map((shipment, idx)=>(
              <tr key={idx}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  {convertUnixTimestampToTime(shipment.deliveryTime)}
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
